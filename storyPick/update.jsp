...
function sendIt() {
	...
	f.action="<%=cp%>/monnmai/story/updated_ok.do?pageNum=${pageNum}&story_id=${dto.story_id}";
		...
		<div class="join-step2">
			...
			<form action="" method="post" name="storyWrite" enctype="multipart/form-data">
				...
				<fieldset class="joinform-field">		
					<legend class="hide">StoryPick 글 수정</legend>
					<h3>글 수정하기</h3>
					...
					<ul>						
						<li>
							<label>
								...
								<input type="text" name="story_subject" value="${dto.story_subject }" placeholder="제목 입력">
							</label>
						</li>
						...
						<li>
							<label>
								...
								<textarea name="story_content" rows="20" cols="100">${dto.story_content }
								${dto.story_id }
							</textarea>							
							</label>						
						</li>
