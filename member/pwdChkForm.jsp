...
<script>
	...
	$(document).ready(function(){
		$("#memberPwd").keydown(function(key){
			if(key.keyCode == 13){
				pwdCheck();
			}
		});
	...
	function pwdCheck(){
		...
		// 현재 비밀번호 체크
		$.ajax({
			 url: "/w/ajax/login/nowPwdChkAjax.do",
			 data : {
			 ...
			 success: function(flag){
				 if(Number(flag) < 1){
					 ...
					 location.href = "/w/mypage/member/memberInfo.do";
// 					 location.href = "/w/mypage/member/memberInfo.do";
				 }
			 }
		});
	...
	<ul>
		<li class="lnb-depth1 lnb-home" data-page="mypage-home">
			<a href="/w/mypage/order/main.do">마이페이지 메인</a>
				...
				<div class="cont-area myinfo">
					<h3 class="tit">개인정보관리</h3>
					<ul class="infotxt">
						<li>개인정보 보호를 위해 비밀번호를 다시 한번 확인합니다.</li>
					</ul>
					<form>
						<fieldset>
							<legend class="hide">비밀번호 확인</legend>
							<div class="line-type1">
								<span><b>아이디</b><input type="text" id="memberId" value="jang040306" title="아이디" readonly></span>
								<span><b>비밀번호</b><input type="password" id="memberPwd" placeholder="비밀번호 입력" title="비밀번호 입력" maxlength="16"></span>
							</div>
							<div class="btn-area">
...
<script type="text/javascript">
	...
	function getSessionId(){
		if(localStorage.getItem("monamiSessionId") == null){
			localStorage.setItem("monamiSessionId","C2CAE5CC7C1E092D3131EB0844474FE4");
		}
