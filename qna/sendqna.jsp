...
<h3 class="title1">MONNAMI <span>INQUIRY</span></h3>
<div class="inquiry">
	<div class="bgarea"></div>
	
	<form name="request_frm" method="post" action="request_ok.php" enctype="multipart/form-data">
			...
			<div class="fl">
				<div>
					<div id="select_box">
						...
						<select id="sel" class="form1" name="form_value[]">
							<option value=""></option>
				...
				<div class="ie9_tit">
					<input type="text" id="form2" name="form_value[]"/><label>*이름</label>
				</div>
				<div class="ie9_tit">
					<input type="text" id="form3" name="form_value[]"/><label>*이메일</label>
				</div>
				<div class="ie9_tit">
					<input type="text" id="form4" name="form_value[]"/><label>연락처</label>
				</div>
				<div class="ie9_tit">
					<input type="text" id="form5" name="form_value[]"/><label>*제목</label>
				</div>
				<div class="ie9_tit">
					<textarea id="form6" name="form_value[]"></textarea><label>*내용</label>
				</div>
				<div>
					<div class="filebox">
...
'㈜몬나미'는 (이하 '회사'는) 정보주체의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다. 회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다. 회사는 개인정보취급방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.
＊ ㈜몬나미의 개인정보 처리방침은 다음과 같은 내용을 담고 있습니다.
...
- 개인정보담당부서 
  : 부서명 : 마케팅팀
  : 전화번호 : 010-1234-1234
  : 이메일 : help2@monnami.com 
- 개인정보보호책임자
  : 성명 : 최설화
  : 전화번호 : 010-1234-1234
  : 이메일 : alclrp011@nate.com
...
개인정보취급방침 시행일자 : 2019년 3월 15일 

 </textarea>
				</div>
				<div class="chkarea">
					<input type="checkbox" id="agree" /><!--  개인정보 수집 및 이용안내에 동의합니다.  -->
				</div>
			</div>	
		</div>
		<div class="btn_send">
			<a href="javascript:request_chk();">SEND</a>
		</div>
	</div>	
	</form>
</div>
...
<%-- 
	<div class="btn_top">
		<a><img src="<%=cp %>/monnami/qna/images/btn_top.gif" alt="페이지 상단으로" /></a>
	</div> --%>
</div><!--/contents-->
