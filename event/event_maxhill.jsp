...
<div class="skip">
	...
	<main id="contents" class="event detail">
				...
				<form name="eventForm" id="eventForm" method="post" onsubmit="return false;">
					...
					<input type="hidden" name="promotionIdx" id="promotionIdx" value="35">
					...
					<div class="inner">
						...
						<div class="detail-cont editor-area">
							<img alt="" src="https://d1bg8rd1h4dvdb.cloudfront.net/upload/imgServer/promotion/editor/2019022216423647485.jpg" style="width: 1200px; height: 2587px;" class="loading" data-was-processed="true">
						</div>
