	...
	<h2>물품등록</h2>
		...
		<div class="join-step2">
			...
			<fieldset class="joinform-field">
				...
				<ul>
					<li>
						<label>
							...
							<input type="hidden" value="${maxNum }" name="product_id">${maxNum }
						</label>
					</li>
					...
					<li>
						<label>
							...
							<input type="text" name="product_name" placeholder="물품명 입력" title="물품명 입력">
						</label>
					</li>
					<li>
						<label>
							<strong>가&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;격<em class="bl-need">*<span class="hide">필수</span></em></strong>
							<input type="text" name="product_cost" placeholder="가격 입력" title="가격 입력">
						</label>
					</li>
					...
					<li>
						<label>
							...
							<input type="radio" name="product_subList1" value="interior" style="left: 153px; top: 18px;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;인테리어&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<input type="radio" name="product_subList1" value="fabric" style="left: 243px; top: 18px;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;패브릭&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<input type="radio" name="product_subList1" value="diary" style="left: 333px; top: 18px;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;다이어리&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							
							<input type="radio" name="product_subList1" value="drawing" style="left: 422px; top: 18px;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;그림
						</label>
					</li>
					...
					<li>
						<label>
							<strong><em class="bl-need"><span class="hide">필수</span></em></strong>
							<input type="radio" name="product_subList2" value="imagin" style="left: 153px; top: 18px;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;어린이&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<li>
						<label>
							<strong><em class="bl-need"><span class="hide">필수</span></em></strong>
							<input type="radio" name="product_subList3" value="life" style="left: 153px; top: 18px;">
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;디자인&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<div class="btn-area">
					<input type="button" class="btn-black" value="확인" onclick="sendIt();">
					<input type="button" class="btn-white" value="취소" onclick="javascript:location.href='<%=cp%>/monnami/product/main.do';">
				</div>
			</fieldset>
	</div>
</main>
