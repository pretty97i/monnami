...
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/common.css" type="text/css"/>
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/contents.css" type="text/css"/>
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/main.css" type="text/css"/>
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/products.css" type="text/css"/>
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/lib/jquery-ui.min.css" type="text/css"/>
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/lib/jquery.scrollbar.css" type="text/css"/>
<link rel="stylesheet" href="<%=cp %>/monnami/content/css/w/lib/swiper.min.css" type="text/css"/>

<script type="text/javascript" src="<%=cp%>/monnami/content/js/cart.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/commonScript.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/function.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/imagesloaded.pkgd.min.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/jquery-3.3.1.min.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/jquery-ui.min.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/jquery.countdown.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/jquery.ez-plus.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/jquery.scrollbar.min.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/lazyload.min.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/monamimall.js"></script>
<script type="text/javascript" src="<%=cp%>/monnami/content/js/swiper.min.js"></script>
