		...
		<div class="inner">
							...
							<ul class="depth3">
								...
								<li>
									...
									<ul>
										...
										<li class="active" ><a href="<%=cp %>/monnami/content/note/content_highlight.jsp">글자강조(Highlighting)</a></li>
								...
								<li>
									...
									<ul>
										...
										<li ><a href="<%=cp %>/monnami/content/interior/content_interior.jsp">인테리어/소품 꾸미기</a></li>
			...
			<div class="category-sort">
				<div class="inner-sort">
					<h3>글자강조(Highlighting)</h3><span>등록상품 : <b> 28</b> 개</span>
